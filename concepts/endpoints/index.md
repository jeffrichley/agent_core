...
deliver() blocks the dispatch loop
...
For exact `SupervisorConfig` field names and defaults, see the [API Reference](https://jeffrichley.github.io/agent_core/reference/index.md).
