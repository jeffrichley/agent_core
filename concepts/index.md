...
New to agent-core? Read the [Architecture](https://jeffrichley.github.io/agent_core/concepts/architecture/index.md) page first for a full system diagram and noun definitions.

These concepts build on each other in order:

| Concept                                                                                 | What it does                                                 |
| --------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Architecture](https://jeffrichley.github.io/agent_core/concepts/architecture/index.md) | How the daemon, bus, endpoints, beings, and sidecars compose |
