...
Daemon restarts are transparent to beings
...
See [The bus](https://jeffrichley.github.io/agent_core/concepts/bus/index.md) for the full delivery lifecycle diagram, redelivery sweeps, TTL expiry, and dead-letter handling.
...
See [Extensions](https://jeffrichley.github.io/agent_core/concepts/extensions/index.md) for the full plugin contract: entry-point naming, how hooks and envelope kinds are contributed, and how to write your own extension.

## Read more

| Topic                                 | Page                                                                                           |
| ------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Bus delivery lifecycle, hooks, config | [The bus](https://jeffrichley.github.io/agent_core/concepts/bus/index.md)                      |
| Envelope fields and built-in kinds    | [Envelopes](https://jeffrichley.github.io/agent_core/concepts/envelopes/index.md)              |
| Endpoint protocol and supervision     | [Endpoints](https://jeffrichley.github.io/agent_core/concepts/endpoints/index.md)              |
| Plugin hooks and extension types      | [Extensions](https://jeffrichley.github.io/agent_core/concepts/extensions/index.md)            |
| Running the daemon                    | [Running the daemon](https://jeffrichley.github.io/agent_core/getting-started/daemon/index.md) |
