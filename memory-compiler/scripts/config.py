...
# ── Paths ──────────────────────────────────────────────────────────────
# memory-compiler lives at agent_core/memory-compiler/
# Scripts are at agent_core/memory-compiler/scripts/
COMPILER_DIR = Path(__file__).resolve().parent.parent
ROOT_DIR = COMPILER_DIR.parent  # agent_core project root
DAILY_DIR = COMPILER_DIR / "daily"
KNOWLEDGE_DIR = COMPILER_DIR / "knowledge"
