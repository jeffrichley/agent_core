...
|---|---|---|---|---|
| **A** | **Repo / extension strategy** | 🔴 Not started — **next up** | — | Foundational. Naming (is `agent-core` a misnomer?), monorepo vs core+plugins, distribution model. Drives where every other piece lives. |
