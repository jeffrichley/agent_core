...
1. Send a message to yourself: use `bus_send` with `to="<your-being>"`, `kind="TextMessage"`, `payload={"text": "hello"}`.
1. List pending messages: use `list_pending` — your message should appear.
1. Acknowledge the message: use `handle` with the envelope ID from the previous step.
...
| Page                                                                                                 | What it covers                                                 |
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| [Your first endpoint](https://jeffrichley.github.io/agent_core/getting-started/first-agent/index.md) | The `Endpoint` protocol; writing and running a custom endpoint |
| [Running the daemon](https://jeffrichley.github.io/agent_core/getting-started/daemon/index.md)       | Prod/source/test instances, upgrades, troubleshooting          |
| [Concepts](https://jeffrichley.github.io/agent_core/concepts/index.md)                               | Bus, envelopes, endpoints, the full runtime model              |
